...
<body>
    ...
    <main class="d-flex justify-content-center align-items-center" id="qrlogin-main">
        <section>
            <div class="container text-center" id="login">
                <article>
                    <div class="card shadow-sm">
                        ...
                        <div class="card-body"><img src="assets/img/accountQRAccess.svg" width="200px" height="200px" alt="QR이미지"></div>
                        <div class="card-body">
                            <h6 class="text-muted card-subtitle mb-2">남은 시간 10:00</h6>
                        </div>
                        <div class="card-footer"><a class="text-decoration-none" href="index.html">취소</a></div>
                    </div>
                </article>
            </div>
        </section>
