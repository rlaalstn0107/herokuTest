...
<body>
    ...
    <main class="d-flex justify-content-center align-items-center" id="register-main">
        <div class="container p-0">
            <article>
                <div class="row m-0">
                    <div class="col d-none d-lg-block w-auto p-0">
                        <div class="card visible h-100 mw-100">
                            <div class="card-body"><img class="img-fluid" src="https://cdn.dribbble.com/users/67884/screenshots/5380640/recycle_right_-_recycling_stations.gif" alt="회원가입 안내 이미지">
                                <p>Aenean tortor est, vulputate quis leo in, vehicula rhoncus lacus. Praesent aliquam in tellus eu gravida. Aliquam varius finibus est.<br></p>
                            </div>
                        </div>
                    </div>
                    <div class="col p-0">
