                                ...
                                <div class="col p-0">
                                    <form>
                                        <div class="input-group"><select class="border rounded form-select w-25" name="community-category">
                                            ...
                                            </select><input class="border rounded form-control w-50" type="search" placeholder="내용을 입력하세요" name="community-search"><button class="btn btn-primary" type="submit" style="width: 46px;height: 46px;"><i class="fas fa-search"></i></button></div>
                                    </form>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="table-responsive">
                                <table class="table table-hover">
                                    <tbody>
                                        ...
                                        <tr>
                                            <td><a class="d-block text-decoration-none text-reset" href="content.html">글내용 샘플입니다아~<span class="text-info">(3)</span><br></a></td>
                                            <td><a class="text-end d-block text-decoration-none text-reset" href="/content">옥재욱</a></td>
                                            <td class="d-none d-lg-table-cell"><a class="text-end d-block text-decoration-none text-black-50" href="/content">2008/01/03<br></a></td>
                                        </tr>
                                    </tbody>
