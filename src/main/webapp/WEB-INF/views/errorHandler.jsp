...
<body>
    <header id="header">
        ...
        <div class="container-fluid text-white d-flex d-lg-block d-xxl-flex justify-content-center align-items-center justify-content-xxl-center align-items-xxl-center" id="highlight">
